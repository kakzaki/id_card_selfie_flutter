...
class IDCardSelfie extends StatefulWidget {
  const IDCardSelfie(
      this.camera,
      this.onCapture, {
        Key? key,
  ...
  @override
  _FlutterIDCardSelfieState createState() => _FlutterIDCardSelfieState();
}

class _FlutterIDCardSelfieState extends State<IDCardSelfie> {
  _FlutterIDCardSelfieState();
